...
#define ADCx_CHANNEL2_GPIO_PORT          GPIOC

#define ADCx_CHANNEL3_PIN                GPIO_PIN_2
#define ADCx_CHANNEL3_GPIO_PORT          GPIOC

/* Definition for ADCx's Channel */
#define ADCx_CHANNEL1                    ADC_CHANNEL_1
#define ADCx_CHANNEL2                    ADC_CHANNEL_2
#define ADCx_CHANNEL3                    ADC_CHANNEL_3
